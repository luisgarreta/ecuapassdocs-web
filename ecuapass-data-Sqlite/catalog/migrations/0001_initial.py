    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documento', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.cartaportedoc')),
                ('remitente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.empresa')),
            ],
        ),
        migrations.CreateModel(
            name='Manifiesto',
            fields=[
                ...
                ('numero', models.CharField(max_length=20)),
                ('fecha_emision', models.DateField(default=datetime.date.today)),
                ('cartaporte', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='catalog.cartaporte')),
                ('documento', models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='catalog.manifiestodoc')),
                ('vehiculo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='vehiculo', to='catalog.vehiculo')),
            ],
        ),
    ]
